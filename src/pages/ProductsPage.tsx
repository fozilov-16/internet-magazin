...
export default function ProductsPage() {
  ...
  if (loading) {
    return (
      <div className="px-4 md:px-[135px] py-12">
  ...
  if (error) {
    return (
      <div className="px-4 md:px-[135px] py-12 text-red-500">
        {error}
      </div>
    );
  }
              ...
              <div key={prod.id} className="w-full sm:w-[180px] md:w-[260px]">
                <div className="bg-[#F5F5F5] p-4 rounded-xl relative group">
                  ...
                  <div className="absolute top-3 right-3 flex flex-col gap-2 z-10">
                    ...
                    >
                      <Heart
                        className={isInWishlist(prod.id) ? "fill-red-500 text-red-500" : "text-gray-400"}
                      />
                    </button>
